...
aliquot_sum = sum([x for x in range(1,number) if number % x == 0])
newList = [perfect.append(number) if aliquot_sum == number else abundant.append(number) if aliquot_sum > number else deficient.append(number) for number in range(29)]
print (newList)
print('================================================================================\n')